        ...
        >
            ...
            <div className='flex flex-col text-textColor gap-y-5 px-5'>
                ...
                <p className='text-xl font-normal text-gray-400'>
                    Hardworking and passionate job seeker from Bina Nusantara
                    University majoring in Computer Science Global Class with
                    strong organizational skills eager to secure internship of
                    Software Engineer. Ready to help team achieve company goals.
                </p>
                ...
                <a
                    href='https://drive.google.com/file/d/1vakU54BtvwdIWDRMav7xRz3EkOC7HoBs/view?usp=sharing'
                    target='_blank'
                    rel='noopener noreferrer'
